  ...
  return (
    <div className={styles.container}>
      <Head>
        ...
        <meta
          name="keywords"
          content="Offshore outsourcing, Freelancers, php Programmers, Coders, Developers, Writers, Web Designers, Website Design, Technical Writers"
        />
        <meta
          name="description"
